...
public class CcairbagCarouselController extends BaseController
{
     ...
     * 查询轮播图列表
     */
    @RequiresPermissions("system:ccairbag/carousel:list")
    @GetMapping("/list")
     ...
     * 导出轮播图列表
     */
    @RequiresPermissions("system:ccairbag/carousel:export")
     ...
     * 获取轮播图详细信息
     */
    @RequiresPermissions("system:ccairbag/carousel:query")
     ...
     * 新增轮播图
     */
    @RequiresPermissions("system:ccairbag/carousel:add")
     ...
     * 修改轮播图
     */
    @RequiresPermissions("system:ccairbag/carousel:edit")
     ...
     * 删除轮播图
     */
    @RequiresPermissions("system:ccairbag/carousel:remove")
