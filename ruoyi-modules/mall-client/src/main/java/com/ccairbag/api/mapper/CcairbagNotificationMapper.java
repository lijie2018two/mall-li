 ...
 * @date 2025-02-20
 */
public interface CcairbagNotificationMapper 
{
    /**
     * 查询通知
     * 
    ...
    public List<CcairbagNotification> selectNotificationList(Long userId);

    public List<CcairbagNotification> selectNotificationListExt(Long userId);


    int getUserNotificationUnreadCount(Long userId);
    /**
     * 查询通知列表
     * 
    ...
    int updateReadStatusByNotificationIds(
