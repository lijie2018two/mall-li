...
public class DateUtil {
    ...
    public static long orderCountdown(long orderTime) {
    	...
    	if(orderCountdown > ApplicationConst.THREE_MINUTE) {
            ...
            Long i = ApplicationConst.THREE_MINUTE - orderCountdown;
            System.out.println("倒计时时间："+i+"ApplicationConst.THREE_MINUTE:"+ApplicationConst.THREE_MINUTE+"orderCountdown:"+orderCountdown);
...
//        long currentMillis = System.currentTimeMillis();
//        String currentMilliss = long2strTime(currentMillis);
//        String now = getCurrentYMD()+" 16:30:00";
//        long nows = str2longTime(now);
//        String ss = long2strTime(nows);
//        System.out.println("now "+now);
//
//        System.out.println("currentMilliss "+currentMilliss);
//        System.out.println("currentMillis "+currentMillis);
//        System.out.println("nows "+nows);
//        System.out.println(nows>currentMillis);
//        System.out.println("ss "+ss);

        int number=(int)(Math.random()*90+10);//生成一个[10,100]范围内的随机数

        System.out.println("随机数 "+number*100);
    }
}
