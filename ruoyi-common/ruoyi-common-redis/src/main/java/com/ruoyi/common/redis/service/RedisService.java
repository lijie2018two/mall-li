...
public class RedisService
{
    ...
    public Set<Object> zrevrangeByScore(String key, double maxScore, double minScore, long offset, long count) {
        return redisTemplate.opsForZSet().reverseRangeByScore(key, maxScore, minScore, offset, count);
    }
