...
public class AppTokenService {
    ...
    private static final String audience = "you";

    private final static String ACCESS_TOKEN = CacheConstants.APP_LOGIN_TOKEN_KEY;
...
//    private String secret;
    ...
    public Map<String, Object>  createToken(LoginAppUser loginUser)
    {
        ...
        Long userId = loginUser.getCcairbagUsers().getUserId();
//        String token = IdUtils.fastUUID() + userId;
        String token = IdUtils.fastUUID() +"-"+ userId+"-"+System.currentTimeMillis();
        String userName = loginUser.getCcairbagUsers().getUserName();
        ...
        claimsMap.put(SecurityConstants.APP_USER_ID, loginUser.getCcairbagUsers().getEmail());
