<template>
  <div class="app-container">
    <el-form :model="queryParams" ref="queryForm" size="small" :inline="true" v-show="showSearch" label-width="68px">
      ...
      <el-form-item label="是否删除;0 正常  1 删除" prop="deleted">
        <el-input
    ...
    <el-row :gutter="10" class="mb8">
      <el-col :span="1.5">
        <el-button
          ...
          size="mini"
          @click="handleAdd"
          v-hasPermi="['system/ccairbag:favorite:add']"
        >新增</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button
          ...
          :disabled="single"
          @click="handleUpdate"
          v-hasPermi="['system/ccairbag:favorite:edit']"
        >修改</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button
          ...
          :disabled="multiple"
          @click="handleDelete"
          v-hasPermi="['system/ccairbag:favorite:remove']"
        >删除</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button
          ...
          size="mini"
          @click="handleExport"
          v-hasPermi="['system/ccairbag:favorite:export']"
        >导出</el-button>
      </el-col>
    ...
    <el-table v-loading="loading" :data="favoriteList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="是否删除;0 正常  1 删除" align="center" prop="deleted" />
    ...
    <el-dialog :title="title" :visible.sync="open" width="500px" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="80px">
        ...
        <el-form-item label="是否删除;0 正常  1 删除" prop="deleted">
          <el-input v-model="form.deleted" placeholder="请输入是否删除;0 正常  1 删除" />
        </el-form-item>
      </el-form>
...
<script>
import { listFavorite, getFavorite, delFavorite, addFavorite, updateFavorite } from "@/api/system/ccairbag/favorite";
...
export default {
  ...
  methods: {
    ...
    /** 导出按钮操作 */
    handleExport() {
      this.download('system/ccairbag/favorite/export', {
        ...this.queryParams
