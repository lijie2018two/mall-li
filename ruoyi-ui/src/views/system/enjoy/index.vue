<template>
  <div class="app-container">
    <el-form
      ...
      v-show="showSearch"
    >
      <el-form-item label="收藏人名称" prop="uName">
        <el-input
          v-model="queryParams.uName"
          placeholder="请输入点赞人名称"
          clearable
    ...
    >
      <el-table-column label="收藏人头像" align="center" prop="headimgurl">
        <template slot-scope="scope">
          <image-preview :src="scope.row.headimgurl" :width="50" :height="50" />
        </template>
      </el-table-column>

      <el-table-column label="收藏人名称" align="center" prop="uName" />
...
export default {
  ...
  methods: {
    ...
    getList() {
      ...
      if (this.intelligentId != null) {
        this.$set(this.queryParams, "intelligentId", this.intelligentId);
      }
